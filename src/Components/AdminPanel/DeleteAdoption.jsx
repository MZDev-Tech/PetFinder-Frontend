...
const DeleteAdoption = ({ setdeleteModal,currentId,refreshAdoption}) => {

const handleDelete=async()=>{
try{
    await axios.delete(`http://localhost:8081/api/adoption/${currentId}`);
    setdeleteModal(false);
    refreshAdoption();
    toast.success( 'Adoption Delete Successfully..');
