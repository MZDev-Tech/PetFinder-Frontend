...
const DeleteShelters = ({ setdeleteModal,currentId,refreshShelters}) => {

const handleDelete=async()=>{
try{
    await axios.delete(`http://localhost:8081/api/shelters/${currentId}`);
    setdeleteModal(false);
    refreshShelters();
    toast.success( 'Shelter Data Delete Successfully..');
